...
//    @Pointcut("execution(@com.yaxon.wuliudriver.utils.aop.annotation.DebugLog * *(..))")
...
//    }
    ...
    @Pointcut("@within(com.yaxon.wuliudriver.utils.aop.annotation.DebugLog)||@annotation(com.yaxon.wuliudriver.utils.aop.annotation.DebugLog)")
